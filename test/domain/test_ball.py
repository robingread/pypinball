...
class TestBall(unittest.TestCase):
    def test_set_ball_position(self):
        ball = pypinball.domain.Ball(uid=0, position=(0.0, 0.0))
    ...
    def test_get_ball_position_history(self):
        ball = pypinball.domain.Ball(uid=0, position=(0.0, 0.0), history=3)
    ...
    def test_get_ball_position_history_maximum_not_reached(self):
        ball = pypinball.domain.Ball(uid=0, position=(0.0, 0.0), history=5)
